 ...
 * 사용법:
 *   npm run perf:test
 *   node performance/scripts/performance-test.mjs
 */
...
async function testVersion(browser, version, scenario) {
  ...
  try {
    ...
    const url = `file://${join(projectRoot, 'performance', 'html', htmlFile)}`;
...
async function runAllTests() {
  ...
  try {
    ...
    // 결과 저장
    const outputDir = join(projectRoot, 'performance', 'performance-results');
